...
const FYI = () => {
  return (
    <Layout
      metaKeywords="soultan muhammad albar fyi, about soultan muhammad albar, about soultan albar, about soultanid, soultan, about soultan, nextjs, soultan portofolio, soultan muhammad albar portofolio"
